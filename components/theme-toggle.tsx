...
export function ThemeToggle() {
  ...
  return (
    <div className="relative">
      ...
      <motion.button
        onClick={() => setIsOpen(!isOpen)}
        className="w-12 h-12 rounded-xl bg-muted hover:bg-accent flex items-center justify-center transition-colors group"
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.9 }}
        data-cursor-hover
      >
        <Palette className="w-5 h-5 text-foreground opacity-70 group-hover:opacity-100" />
      </motion.button>
